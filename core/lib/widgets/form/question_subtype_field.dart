...
class QuestionSubtypeField<T> extends FormBuilderField<T> {
  ...
  QuestionSubtypeField(
      ...
      : super(
          ...
          builder: (FormFieldState<T?> field) {
            final state = field as _QuestionSubtypeFieldState<T>;
            return Row(
              children: [
                if (questionMsg != null)
                  Expanded(
  ...
  @override
  _QuestionSubtypeFieldState<T> createState() =>
      _QuestionSubtypeFieldState<T>();
}

class _QuestionSubtypeFieldState<T>
    extends FormBuilderFieldState<QuestionSubtypeField<T>, T> {}
